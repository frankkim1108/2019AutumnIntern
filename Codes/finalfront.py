...
def getfrontcoord(imgfront):
    ...
    with open('../humanmeasurement/json/' + "finalfront" + '.json', 'w') as outfile:
    ...
    Body = {'nose': 0, 'chest': 2, 'left shoulder': 4, 'left arm': 6, 'left wrist': 8, 'right sholder': 10,
            'right arm': 12,
            'right wrist': 14,
    ...
    cv2.imwrite("./image/" + "realfinalfront.png", final)
    cv2.imwrite("./image/" + "bonefront.png", op_res)
